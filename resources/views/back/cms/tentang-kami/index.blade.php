            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <a class="mt-3 btn btn-sm btn-primary" href="{{ $tentangKami !== null ? $tentangKami->gambar() : asset('back_assets/img/public/noimage-png') }}" target="_blank">Preview Gambar</a>
                    </div>
                </div>
                <div class="col-md-12">
                    <div class="form-group">
...
<script>
    $('#form-validation').validate({
        ...
        messages: {
            ...
            deskripsi: {
                required: "Field wajib diisi!",
                maxlength: "Harap masukkan tidak lebih dari 618 karakter.",
            },
            gambar: {
